...
\begin{itemize}
  \item \textbf{JSON export}: writes the raw call log array plus a pre-computed metrics summary (provider success rates, total tokens, average latency) to \texttt{ai\_call\_log\_[timestamp].json}.
