...
Before the main game loop begins, the player is presented with a ten-page visual-novel-style prologue implemented across \texttt{intro\_story.gd}, \texttt{intro\_story\_data.gd}, and \texttt{intro\_page.gd}, with illustrated panels stored in \texttt{src/assets/ui/intro/}. The sequence is paginated and fully localised via \texttt{intro\_story\_pages.csv} (English, Chinese, and German).

The prologue establishes the game's central dramatic irony: in a post-apocalyptic wasteland choked by acidic smog, the protagonist is a guarded, rational survivor who trusts only their silent companion, One. A chance encounter with Gloria --- an enigmatic young woman in an inexplicably clean white cloak --- sets the trap. Gloria exploits the protagonist's loneliness and their shared ``6767 personality type'' to present the FSM's Law of Attraction as cosmic proof of their destined meeting. Over ten pages, the protagonist's rational alarms are systematically dismantled through manufactured intimacy, victim-blaming framed as spiritual wisdom, and One's quiet compliance, until the protagonist voluntarily cuts off their own critical thinking to accept Gloria's invitation. The ``Glorious Deliverance Agency (GDA1)'' is thus founded not through heroism but through self-suppressed reason --- establishing the thematic contract the player must navigate for the rest of the game.
