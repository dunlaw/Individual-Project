...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=6mm and 10mm]
        ...
        \node[reportwide, fill=ReportBlue!60, text width=52mm]
            (static) {\textbf{Static Context Layer}\\{\scriptsize\texttt{ai\_context\_builder.gd}}\\{\scriptsize World bible, persona, rules}};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=7mm and 8mm]
        ...
        \node[reportsmall, fill=ReportBlue!35, below=4mm of db]
            (sl) {\textbf{SaveLoadSystem}\\{\scriptsize\texttt{save\_load.gd}}};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=8mm and 12mm]
        ...
        \node[reportsmall, fill=ReportLavender!50, below=of ai]
            (parser) {\textbf{ResponseParser}\\{\scriptsize JSON + directives}};
        % --- Memory ---
