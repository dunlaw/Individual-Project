extends Control
# Main orchestrator for the AI settings menu.
# UI layout construction  → ai_settings_menu_builder.gd
# Provider state & labels → ai_settings_menu_provider_ui.gd
# Settings load / save    → ai_settings_menu_settings_io.gd
# Event handlers          → ai_settings_menu_handlers.gd
...
# --- Public interface (called from scene signals & helpers) ---
...
# --- Scene-connected button handlers ---
